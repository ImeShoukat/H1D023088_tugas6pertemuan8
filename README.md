...
* Di sinilah passing data terjadi. Kita membuat instance baru dari `Mhs_Detail` dan langsung memasukkan semua variabel (`NamaMahasiswa`, `NIMMahasiswa`, `birthYear`, `age`) ke dalam constructor-nya.
````
...
````
#### Penerimaan Data di Halaman Detail (`detail.dart`)
